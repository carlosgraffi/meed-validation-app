 ...
 * - Current step: filled, animated pulse ring
 * - Future steps: outlined, muted
 *
 * Sections C and E don't get their own step on the stepper — they're
 * grouped under Stage 2 and Stage 3 respectively in the user's mental
 * model (the spec frames the three stages as Top-3 / Top-10 / Order).
 */
